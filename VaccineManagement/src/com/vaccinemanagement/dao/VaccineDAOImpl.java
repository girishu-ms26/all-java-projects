...
public class VaccineDAOImpl implements VaccineDAO {
	...
	public void Contact(Contact theContact) {
		Session currentSession = sessionFactory.getCurrentSession();
		currentSession.save(theContact);
	}
	...
	public List<Citizen> searchCitizen(String Fname){
		Session currentSession = sessionFactory.getCurrentSession();
		String hql = "select C from Citizen C where first_name= :first_name";
		Query<Citizen> theQuery = currentSession.createQuery(hql);
		theQuery.setParameter("first_name",Fname);
		List<Citizen> citizens = theQuery.list();	
		return citizens;
	}
}
